...
import { XMarkIcon, AddUserIcon } from '../utils'; // Changed PlusIcon to AddUserIcon
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-brand-surface rounded-lg shadow-xl p-6 w-full max-w-md max-h-[80vh] flex flex-col">
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-slate-600">
          ...
          <button onClick={handleConfirmSelection} className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 flex items-center">
           <AddUserIcon className="w-5 h-5 mr-1" /> Crear Equipo ({selectedPlayerIds.size} jug.)
          </button>
        </div>
      </div>
    </div>
